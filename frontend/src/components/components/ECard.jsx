  ...
  return (
    <>
      ...
      {variant === "eventSchedule" && (
        <Card
          raised="true"
          sx={{ borderRadius: 4, width: "80vw", height: "15vw" }}
        >
          <CardActionArea>
            <Grid container>
              <Grid item xs={2} bgcolor="#F83E7D">
                <Stack alignItems="center" pt="2.2vw">
                  <Typography
                    variant="h2"
                    sx={{ fontWeight: "bold", color: "white", fontSize: "4vw" }}
                  >
                    25
                  </Typography>
                  <Typography
            ...
            <Grid container spacing={2}>
              <Grid item xs={8}>
                <Box display="flex" alignItems="center">
                  ...
                  <Typography
                    variant="h6"
                    sx={{ fontWeight: "bold", color: "#0045F1" }}
                  >
                    {location}
                  </Typography>
                </Box>
      ...
      {variant === "long" && (
        <Card raised="true" sx={{ borderRadius: 5, width: "60vw" }}>
          <Stack direction="row">
            ...
            <Button
              sx={{ color: "white", background: "#32323299", width: "113px" }}
            >
              <ArrowForwardIosIcon />
            </Button>
          </Stack>
