  ...
  return (
    <div> 
      <IconButton onClick={() => setOpen(!open)}>
        <StyledButton variant="pinkBtn" bgcolor='#0045F1'> Filters </StyledButton>
      </IconButton>
      <Drawer
        variant="persistent"
        anchor="left"
        ...
        <Stack marginX={'2vw'} alignItems={'center'} maxWidth={'25vw'}>
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={liveIn}
                    onChange={(event, value) => {setLiveIn(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={NOBedrooms}
                    onChange={(event, value) => {setNOBedrooms(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={NOBathrooms}
                    onChange={(event, value) => {setNOBathrooms(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={utilities}
                    onChange={(event, value) => {setUtilities(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={NOHousemates}
                    onChange={(event, value) => {setNOHousemates(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={furnished}
                    onChange={(event, value) => {setFurnished(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={pets}
                    onChange={(event, value) => {setPets(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={parking}
                    onChange={(event, value) => {setParking(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={airCon}
                    onChange={(event, value) => {setAirCon(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Container>
                ...
                <ToggleButtonGroup
                    exclusive
                    value={smoking}
                    onChange={(event, value) => {setSmoking(value)}}
                    sx={{flexWrap: 'wrap'}} 
                >
                    <ToggleButton value={'no preference'} sx={CustomToggleButtonStyles}>
                        No Preference
            ...
            <Box marginY={'5vh'}>
                <StyledButton variant="pinkBtn" width='15vw' bgcolor='#0045F1' onClick={handleSubmit}> Filter </StyledButton>
            </Box>
        </Stack>
      </Drawer>
    </div>
