  ...
  return (
    <Box marginX={"10vw"} marginBottom={"10vh"}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Grid container spacing={10}>
          ...
          <Grid item xs={12}>
            <Box
              ...
              Place holder for Consent Form and Info
            </Box>
          </Grid>
        </Grid>
        ...
        <Box display="flex" justifyContent="center">
          <StyledButton variant="pinkBtn" text="Submit" type="submit"></StyledButton>
        </Box>
      </form>
    </Box>
  );
...
export default connect(mapStateToProps, { create_private_event })(EventSignup);
