          ...
          <Grid container py={10} px={15}>
            <Grid item xs={8}>
              <div className="header-txt-wrapper">
                ...
                <h1 className="headerPink">Women?</h1>
                <Divider style={{ marginBottom: "2rem" }} width="50%" />
                <div>
                  <Typography className="accTextcolor" variant="h5">
                    Aisha Comfortable Coliving is a platform that works to empower women by matching like-minded women
                    to colive in a safe and enjoyable space. We strive to build an inclusive, supportive, and fun
            ...
            <Grid item xs={4}>
              <div className="img-wrapper">
                <Box component="img" alt="Lady on hompage" src={require("../../assets/HomePhoto2.png")} />
              </div>
            </Grid>
          </Grid>
        </div>
      ...
      <div className="acc-section blue-grad-bg">
        <div className="acc-container ">
          <Stack p={6} pb={20} spacing={3} alignItems="center">
              ...
              <Grid item>
                <Card sx={{ width: "320px", borderRadius: 5, height: "420px" }} raised>
                  ...
                  <Stack p={5} align="center" spacing={4} alignItems="center">
                    ...
                    <Typography style={{ fontWeight: 500 }} className="accTextcolor" variant="p" fontSize={"1rem"}>
                      Coliving enables you to have more economic security, time, and freedom to enjoy all the good
            ...
            <Typography
              className="accTextcolor"
              variant="h5"
              align="center"
              py={10}
              px={35}
              style={{ fontWeight: "bold" }}>
              Watch this short video to hear <span className="accBlue mui-h5">Wendy and Innes</span> talk about how they
              began <span className="accBlue mui-h5">coliving</span> and how their lives have changed since.
            </Typography>
        ...
        <div className="acc-container">
          <Stack sx={{ p: 5 }}>
            ...
            <Grid container pt={10}>
              ...
              <Grid item xs={6} mt={15}>
                <Box component="img" src={quote2} sx={{ width: "40rem" }} />
              </Grid>
              <Grid item xs={6}>
                <Stack alignItems="center" spacing={2}>
                  <Typography variant="h4" sx={{ color: "#F83E7D", fontWeight: "bold" }}>
                ...
                <Card sx={{ width: "350px", height: "501px", borderRadius: 5 }} raised>
                  ...
                  <Stack p={"1.8rem"} align="center" spacing={1} alignItems="center">
                    ...
                    <Typography
                      ...
                      padding={2}
                      className="accTextcolor accFontsize"
                      variant="p">
                      We are a digital platform that matches tenants and women homeowners, based on shared lifestyles
                      and needs. Our platform allows compatible women to connect in a comfortable, shared living space.
                ...
                <Card sx={{ width: "350px", height: "501px", borderRadius: 5 }} raised>
                  ...
                  <Stack p={"1.8rem"} align="center" spacing={1} alignItems="center">
                    ...
                    <Typography
                      ...
                      className="accTextcolor accFontsize"
                      variant="p">
                      We host regular online community-building events designed around health, fitness, culture, and
                      fun. By joining our platform, you can enjoy positive bonding experiences with Aisha Community
                ...
                <Card sx={{ width: "350px", height: "501px", borderRadius: 5 }} raised>
                  ...
                  <Stack p={"1.8rem"} align="center" spacing={1} alignItems="center">
                    ...
                    <Typography
                      ...
                      className="accTextcolor accFontsize"
                      variant="p">
                      We perform thorough background checks on all housemates to ensure a safe living environment. We
                      also aim to increase community spirit and belongingness through events, activities, and meetups.
                      While doing so, we prioritize safety in the homes and community.
                    </Typography>
                  </Stack>
                </Card>
              </Grid>
            ...
            <div className="partner-grid">
              <div className="partner-flex">
                <div className="partner-content">
                  <Divider
                    style={{ height: "0.4rem", width: "11rem", borderRadius: "1rem", color: "#EE5C8E" }}></Divider>
                  <Typography className="accTextcolor" variant="h6">
                    ...
                    Coliving, we know how stressful the process of finding the right tenants for your space can be.
                    Partner with us today to take full advantage of the services we offer our clients, to make the
                    rental journey much smoother for everyone involved.
                  </Typography>
                  <Typography className="accTextcolor" variant="h6" fontWeight="bold">
                    If you would like to know more, have questions about our partnership process, or are ready to become
                    a partner:
                  </Typography>
                  <Typography className="accTextcolor" variant="h6" fontWeight="bold">
                ...
                <div className="parter-content">
                  <div className="partner-content">
                    ...
                    <Typography className="accTextcolor" variant="h6" sx={{}}>
                      To all women looking for safe and affordable living, we have you covered! Share a modern coliving
                      space with a compatible individual matched to you.
                    </Typography>
                    <Typography className="accTextcolor" variant="h6" sx={{}}>
                      Coliving provides the ideal wellness living opportunity to enjoy life in the company of
                      like-minded women in addition to the benefits of a peer group that takes you places.
                    </Typography>
            ...
            <div className="partner-grid">
              <div className="partner-flex">
                <div className="partner-content">
                  ...
                  <Typography className="accTextcolor" variant="h6">
                    Women have proven to be the best renters. They ensure reliable payments and take care of your
                    residence as if you were living there.
                  </Typography>
                  <Typography className="accTextcolor" variant="h6" sx={{ align: "left" }}>
                    We are here to help your investment grow by providing carefully selected renters that you can count
            ...
            <div className="partner-grid">
              ...
              <div className="partner-flex">
                <div className="partner-content">
                  ...
                  <Typography className="accTextcolor" variant="h6" sx={{}}>
                    Sharing your dream home with a like-minded woman can become your best investment into an affordable
                    and enjoyable life.
                  </Typography>
                  <Typography className="accTextcolor" variant="h6" sx={{ align: "left" }}>
      ...
      <div className="acc-section pink-bg">
        <div className="acc-container">
          <Grid container sx={{ p: 10, pb: 30 }}>
            <Grid item xs={5.5}>
              <Typography variant="h3" sx={{ color: "#C5265C", fontWeight: "bold", marginBottom: "1rem" }}>
