    ...
    <>
      <div style={{ overflowX: "hidden" }} className="acc-section">
        <div className="acc-container">
          ...
          <Stack sx={{ mt: "-32rem" }}>
            <Stack pl={15}>
              <Typography variant="h1" sx={{ fontWeight: "bold", color: "white", fontSize: "6rem" }}>
                Find Your
              </Typography>
              <Typography variant="h1" sx={{ fontWeight: "bold", color: "white", fontSize: "6rem" }}>
                Perfect
          ...
          <Stack style={{ background: "white" }} p={6} pb={10} spacing={3} alignItems="center">
            ...
            <Typography variant="h5" sx={{ textAlign: "center", px: "20vw" }}>
              Watch this short video to learn more about how Aisha Comfortable Coliving can best serve you and your
              rental home.
            </Typography>
          ...
          <Grid container p={15} spacing={10} justifyContent="center">
            <Grid item xs={6}>
              <Stack spacing={4} alignItems="center">
                ...
                <Typography variant="h5" sx={{}}>
                  ...
                  property as you would do, is the top reason why property owners partner with Aisha Comfortable
                  Coliving. Women have proven to be the best renters a property owner can have. They take great care of
                  the space they live in. In addition, professional women are reliable rental payers.
                </Typography>
                <Typography variant="h5" sx={{}}>
            ...
            <Grid item xs={6}>
              <Stack spacing={4} alignItems="center">
                ...
                <Typography variant="h5" sx={{}}>
                  There is always the right renter for a stay in your town or city, even if you’re looking to rent it
                  out for a short period. Let Aisha Comfortable Coliving find her for you. With protected financial
            ...
            <Grid item xs={6}>
              <Stack spacing={4} alignItems="center">
                ...
                <Typography variant="h5" sx={{}}>
                  ...
                  similiar interests and values. Having someone to talk to, share a nice meal, listen to music, and
                  share thoughts and feelings with adds quality to our lives. Coffee always tastes better when shared,
            ...
            <Grid container spacing={10} p={10} justifyContent="center">
              <Grid item xs={6}>
                <Stack alignItems="center" spacing={4}>
                  ...
                  <Typography>
                    Coliving provides companionship that ensures a financially secure and comfortable living
                    environment. Coliving with another woman will give you an extra hand to help lift some of the load
                    off your shoulder and make life so much more enjoyable and safe. We will help you find a trustworthy
                    housemate to make your senior years fun!
                  </Typography>
                </Stack>
              </Grid>
              <Grid item xs={6}>
          ...
          <Stack alignItems="center" px={30} py={10} spacing={4}>
            ...
            <Typography variant="h5">
              ...
              and local community first-hand, especially in places where reliable short-term accommodations are harder
              to find.
            </Typography>
            ...
            <Grid item xs="auto">
              <Stack alignItems="center" width="35vw">
                ...
                <Typography>
                  ...
                  Aisha Comfortable Coliving, we organize virtual meetings between housemates to ensure we select the
                  most compatible tentants. Our matching process will help create and maintain a peaceful living
                  environment.
                </Typography>
              </Stack>
            </Grid>
          ...
          <Stack direction="row" style={{ background: "#42ACF980" }} py={10} pb={15} alignItems="center">
            ...
            <Stack spacing={3} ml={-40} alignItems="center">
              ...
              <Typography
                variant="h4"
                color="primary"
                sx={{ textAlign: "center", color: "white", fontWeight: "bold", px: "25rem" }}>
            ...
            <Grid item xs={6}>
              <Stack spacing={4}>
                <Typography variant="h5" sx={{}}>
                  ...
                  break protection for up to 60 days until you find a new tenant Property damage protection up to
                  $10,000 $1,500 coverage of legal eviction fees incurred Paralegal team hired to handle eviction
                  process if necessary Automatic rent collection via pre-authorized debit
                </Typography>
              </Stack>
            </Grid>
            <Grid item xs={6}>
