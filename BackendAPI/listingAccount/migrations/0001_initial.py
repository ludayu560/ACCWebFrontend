    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('tenant', 'Tenant'), ('homeowner', 'Homeowner')], max_length=30, null=True)),
                ...
                ('banner_picture', models.ImageField(null=True, upload_to='banner_picture')),
                ('display_picture_one', models.ImageField(null=True, upload_to='display_picture_one')),
                ('display_picture_two', models.ImageField(null=True, upload_to='display_picture_two')),
                ('display_picture_three', models.ImageField(null=True, upload_to='display_picture_three')),
                ('display_picture_four', models.ImageField(null=True, upload_to='display_picture_four')),
