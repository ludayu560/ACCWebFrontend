    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_image_two', models.ImageField(null=True, upload_to='listing_image_two/')),
                ('listing_image_three', models.ImageField(null=True, upload_to='listing_image_three/')),
                ('listing_image_four', models.ImageField(null=True, upload_to='listing_image_four/')),
            ],
        ),
        migrations.CreateModel(
