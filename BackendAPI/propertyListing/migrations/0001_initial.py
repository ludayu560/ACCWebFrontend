    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_listing', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listing_utilities', to='propertyListing.propertylisting')),
            ],
        ),
    ]
